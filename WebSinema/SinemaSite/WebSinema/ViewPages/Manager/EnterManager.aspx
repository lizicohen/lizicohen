<%@ Page Title="EnterManager" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EnterManager.aspx.cs" Inherits="WebSinema.ViewPages.EnterManager" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentMain" runat="server">
 ...
 <h1 class="mt-3 ml-3">enter Manager</h1>
...
<div class="row">
  ...
  <div class="form-group" dir="ltr">
         ...
         <div class="form-group ">
                    <asp:RadioButtonList ID="rbPermition" runat="server" CssClass="mt-3" RepeatDirection="Horizontal">
                        <asp:ListItem Text="User Standard" runat="server"  Value="StandardUser" class="ml-1" Selected="True"/>
                        <asp:ListItem Text="Manager"  runat="server" Value="Manager" class="ml-1" />
                    </asp:RadioButtonList>
        ...
        <div class="row">
         ...
         <div class="form-group">
            ...
            <div class="col-md-2 mt-5">
                <asp:Button runat="server" OnClick="CreateUser_Click" Text="Add New User" CssClass="btn btn-primary mb-5" />
            </div>
